...
**Prerequisites:** Session 11 reading
...
To follow along interactively, run:
...
**Industry values** follow NAICS labels: Finance, Healthcare, Retail, Manufacturing, Education, Public Administration, Information, Professional Services.

**Employee count ranges:** "1 to 10", "11 to 100", "101 to 1000", "1001 to 10000", "10001 to 25000", "Over 100000", "Unknown"
...
* How the 4-A sections each contain multiple sub-types
* How to parse and access VERIS record fields in Python

**Next:** Proceed to Guide 02 to learn the VERIS 4-A classification categories in depth.

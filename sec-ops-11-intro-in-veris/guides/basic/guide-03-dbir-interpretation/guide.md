...
* "Involved" means "had at least one instance of" — not "caused by"
...
## Reading a DBIR Finding

### Example: "83% of breaches involved external actors"
...
If 83% of breaches are external:
...
### Example: "Phishing was involved in 36% of breaches"
...
1. What regulatory requirements (GDPR Art. 9) are triggered by PHI disclosure?
...
1. **Causation vs. correlation:** Just because phishing is "involved" in 36% of breaches doesn't mean fixing phishing would prevent 36% of breaches.
...
* The key limitations of DBIR data

...
**Format:** Docker-based interactive Python environment
...
You will see how the 4-A framework maps to actual JSON fields and learn to read and navigate a VERIS record.
...
The container starts a Python environment with the VERIS schema loaded, sample incident records, and an interactive explorer.
...
1. **Multiple actions:** Many incidents have multiple action types (e.g., phishing + malware). This reflects the reality that attacks are multi-stage.

1. **Unknown values:** Many fields contain "Unknown" — this reflects real-world uncertainty. VERIS does not require certainty; it allows recording what is known.
